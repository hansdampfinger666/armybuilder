...
i32 Units::add(const string& name)
{
...
i32 Units::add(const i32 id, const string& name)
{

}

bool Units::del(const i32 id, Units& trashbin)
{

}

std::optional<Units::Unit> get(const i32 id)
{
